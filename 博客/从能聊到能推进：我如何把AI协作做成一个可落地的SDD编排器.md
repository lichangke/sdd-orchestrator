# 从“能聊”到“能推进”：我如何把 AI 协作做成一个可落地的 SDD 编排器

做 AI 项目这段时间，我越来越不满意一种状态：**对话经常很顺，项目却不一定真的在推进。**

需求聊清了，不等于阶段已经成立；  
Review 写完了，不等于仓库已经收口；  
子 agent 回来了，也不等于它真的交付了产物，而不是又带回一份计划。

真正麻烦的，从来不是模型这次答得好不好，而是整条协作链路没有工程化。

这个判断不是抽象想出来的，而是被一次次真实问题逼出来的。

比如有一次，我们已经在对话里把一轮需求讨论、方案判断和后续任务聊得很顺了。表面上看，项目像是已经自然进入了下一阶段；但真回到仓库里一看，问题立刻暴露出来：
...
> **AI 协作真正缺的，不是再加几个 prompt，而是一套能管阶段、管状态、管恢复、管交接的推进系统。**

也正是从这种真实失控开始，我和 AI 助手莫邪没有继续堆提示词，也没有停在补几份模板上，而是把整套方法收成了一个 OpenClaw Skill：`sdd-orchestrator`。
...
> **怎么把 AI 协作从“能聊”，推进到“能稳定、可恢复、可交接地做事”。**
