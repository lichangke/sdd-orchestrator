...
12. **文档头元信息必须与正文用途一致**：当文档已切换到当前轮次用途时，必须同步检查文档名称、所属功能 / 子功能、上游文档、创建时间 / 最后更新时间等头部字段是否仍停留在旧轮次；不得出现正文已更新、文档头仍是上一轮信息的不一致状态。  
13. **阶段收口后的稳定快照检查不可遗漏**：当已形成“阶段已收口 / review 已形成 / 验收已通过 / 当前轮次已完成”等结论时，必须同步检查当前工作区是否仍存在与本轮收口直接相关的未提交改动。若仍存在，则不得把当前轮次表达成“完全收口”，至少应明确区分“文档语义已收口”与“仓库快照未收稳”。
...
1. 检查前置阶段是否已确认
2. 检查当前阶段主文档是否已存在
3. 若不存在，先将当前阶段主文档正式落盘到项目中（至少形成草案文件）
4. 再继续该阶段内容起草、讨论与收口，不要先在对话里推进很多再回头补文档
5. 起草后检查文档头元信息是否已对齐当前轮次用途
6. 再检查联动更新

读取：
- 当前阶段主模板
- 当前阶段 checklist
- 若涉及固定入口文档切换 / 轮次覆盖，补读 `references/checklists/document-header-checklist.md`
- 必要时 `references/SDD 联动更新矩阵.md`

### 3. 判断能否进入下一阶段
默认动作（按顺序执行）：
1. 先确认当前阶段主文档已正式落盘到项目中；若尚未落盘，先补文档，不做阶段推进判断
2. 用当前阶段主文档 + checklist 做门禁检查
3. 明确指出“已满足”或“还缺什么”
4. 若推进，先完成当前阶段收口：
   - 回写主文档头部状态
   - 检查文件名是否需改名
   - 检查文档头元信息是否仍残留旧轮次字段
   - 同步更新 `sdd-status.md`、下一步动作与阶段切换结论
5. 完成上述收口后，再开始下游阶段文档
...
默认动作（按顺序执行）：
1. 先看 `sdd-status.md`
2. 再看当前阶段主文档与对应 checklist
3. 检查 `sdd-status.md` 是否与项目内真实已落盘文档状态一致
4. 若状态冲突，先修正文档自洽，再恢复推进
5. 从“下一步唯一推荐动作”继续
...
- 当前阶段主文档
- 对应 checklist
- 若涉及固定入口文档 / 当前轮次映射冲突，补读 `references/checklists/document-header-checklist.md`
- 必要时 `references/SDD 联动更新矩阵.md`
...
2. 再检查任务完成情况与验证结果
3. 再形成结构化 review 结论
4. 用 review checklist 做收口检查
5. 结论形成后同步更新 `sdd-status.md`
6. 若 review 结论表示“已收口 / 已通过 / 阶段性通过”，同步检查当前工作区是否仍有与本轮收口直接相关的未提交改动；必要时形成稳定快照或明确说明尚未收稳

读取：
- `references/core-templates/review.md`
- `references/checklists/review-checklist.md`
- 若 `review.md` 作为固定入口文档承载当前轮次结论，补读 `references/checklists/document-header-checklist.md`
- `references/core-templates/spec.md`
- `references/core-templates/tasks.md`
