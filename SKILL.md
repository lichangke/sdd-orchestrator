...
- 检查前置阶段是否已确认
- 条件不足时先补缺
- 条件足够时，先将当前阶段主文档正式落盘到项目中（至少形成草案文件）
- 再继续该阶段内容起草、讨论与收口，不要先在对话里推进很多再回头补文档
- 起草后检查联动更新
...
- 明确指出“已满足”或“还缺什么”
- 若推进，先完成当前阶段收口：回写主文档头部状态、检查文件名是否需改名、同步更新 `sdd-status.md`、下一步动作与阶段切换结论
- 完成上述收口后，再开始下游阶段文档
...
- 若状态冲突，先修正文档自洽
- `sdd-status.md` 的阶段判断必须锚定项目内真实已落盘文档状态，不得仅按对话理解提前切换
- 从“下一步唯一推荐动作”继续
